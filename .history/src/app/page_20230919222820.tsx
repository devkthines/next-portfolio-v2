...
export default function Home() {
  ...
  return (<>
       ...
       <Navbar className={`${color? 'color-change':''}`} sticky='top' expand="lg" >
...
<Container fluid id='homeCont'>
      <div className={`infoSection mt-5`}>
        ...
        <div id='about'>
          <div ref={ref} className="aboutSection text-center d-flex justify-content-center">
            <Row>
              <h1>About </h1>
              <Col lg={6} id="aboutInfor" >
