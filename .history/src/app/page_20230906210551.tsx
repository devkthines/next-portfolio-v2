...
export default function Home() {
  return (
    <main className="flex flex-col">
      <Header></Header>
      <div className="" className='infoSection bg-stone-800 border border-indigo-600 bg-no-repeat flex flex-row justify-between'>
        <div>
      ...
      <div id='about'>
          ...
          <div className="infoSection">  <h1>About </h1>
      ...
      <div className="infoSection"><h1>Project tiles</h1></div>
    </main>
  )
}
