    ...
    <main>
      <Container fluid id='homeCont'>
        <div className={`infoSection mt-5`}>
          <Row>
            <Col xs={12} sm={12} md={12} lg={6} xl={6} xxl={6} className='d-flex justify-content-end align-self-center'>
              <div>
            ...
            <Col xs={12} md={12} lg={6} xl={6} xxl={6} className='justify-content-start align-self-center'>
