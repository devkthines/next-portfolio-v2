      ...
      {/* <div> */}
        <Row>
          ...
          {/* <div className='d-flex'> */}
            <Card.Img variant="top" id='aboutImg' src='/images/IMG-update.jpg' /> </Col>
          <Col><div id='aboutImgs' className='d-flex'>
             <div> <img  className='aboutImgs' src="/images/webstorm-vs-vscode.jpeg" alt="" />
              <img className='aboutImgs' src="/images/webstorm-vs-vscode.jpeg" alt="" />
              <img className='aboutImgs' src="/images/webstorm-vs-vscode.jpeg" alt="" /></div>
            </div>
            </Col>
             {/* </div> */}
            <Card.Body>
              ...
              <h6>Phone:  Korey Hines</h6> <span className='spanabout'>About</span>
