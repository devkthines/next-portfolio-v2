    ...
    return (
        ...
        <div id='about'>
            <Container fluid>
                <div>
             <Row>
                <Col><img id='aboutImg' src='/images/IMG-update.jpg' alt="" className='' /></Col>
                <Col><h1>About</h1>
...
<Row>
    ...
    <div></div> <div className='text-center'><Progress strokeLinecap="butt" type="circle" percent={75} /><h6>React</h6></div>
