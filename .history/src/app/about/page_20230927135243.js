  ...
  return (
    <div id='about'>
      <Row id='abouttop' className=''>
        <Col xs={3}><div id="abCard"><img variant="top" id='aboutImg' src='/images/image_6487327.JPG' /></div></Col>
        <Col xs={9}> <Row>
          <Col xs={6} id='firstCol'  className='aboutinfo'>
            <div id='abouttext'>
              <h6>About</h6> <p>
                share some goals
          ...
          <Col xs={6} className='aboutinfo'><ul>
          ...
          <Row id='aboutbottom' className=''>
            <Col xs={6} className='aboutinfo'><div id='progress'>
              <h1>Proficiencies</h1>
              {proficiencies.map(x =>
                <div key={x.id}>
                  <h6>{x.name}</h6>
            ...
            <Col xs={6} className='aboutinfo'><div id='timeline'>
              <h1>Experience</h1>
              <Timeline
                // mode="alternate"
                items={[
