...
export default function ProjectModal(){
    ...
    return(
        ...
        <div className='flex flex-row'>
          <Image className="imgTest" width={300} height={300} src='/images/image_67198465.JPG' alt=''/>
          <Image className="imgTest" width={300} height={300} src='/images/image_67198465.JPG' alt=''/>
          <Image className="imgTest" width={500} height={300} src='/images/image_67198465.JPG' alt=''/>
          <Image className="imgTest" width={500} height={300} src='/images/image_67198465.JPG' alt=''/>
        </div>
        </>
    )
