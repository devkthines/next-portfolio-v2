        ...
        <Row id='gallery' className={
          ...
          <Col id='imageTile1'><img id='tile1' src={projectJson[0].image} />
            <div className="middle">
              <div className="text"><button key={0} onClick={() => expandTile()}>Hello</button></div>
            </div>
          </Col>
          <Col><img key={1} src={projectJson[1].image}alt="" />
            <img key={2} src={projectJson[2].image} alt="" />
          </Col>
        </Row>
      </Container>
    </>
