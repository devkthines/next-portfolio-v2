...
export default function Home() {
  return (
    <main className="flex flex-col">
      <Header></Header>
      <div className="s" className=' bg-stone-800 border border-indigo-600 bg-no-repeat flex flex-row justify-between'>
        <div>
      ...
      <div className="s"><h1>Project tiles</h1></div>
    </main>
  )
}
