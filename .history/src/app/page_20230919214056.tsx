...
{/* </Container> */}
      ...
      <Container fluid><div className={`infoSection mt-5`}>
        <Row xs={6} md={8} lg={12} xl={12} xxl={12}>
          <Col xs={2} md={4} lg={6} xl={12} xxl={12} className='d-flex justify-content-end align-self-center'>
            <div>
          ...
          <Col xs={2} md={4} lg={6} className=' justify-content-start align-self-center'>
