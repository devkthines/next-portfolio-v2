...
export default function Home() {
  ...
  return (<>
    <main >
       <Navbar className={`${color? 'color-change':'bg-body-tertiary'} flex `} sticky='top' expand="lg" >
...
<Container fluid>
      ...
      <Container fluid><div className={`infoSection `}>
        <Row xs={2} md={4} lg={6}>
          <Col xs={2} md={4} lg={6} className='d-flex justify-content-center align-self-center'>
            <div>
          ...
          <Col xs={2} md={4} lg={6} className=' d-flex justify-content-start align-self-center'>
            <img id='portrait' src='/images/IMG-6163.jpg' alt="" className='' />
          </Col>
        </Row>
      </div>
        <div id='about'>
